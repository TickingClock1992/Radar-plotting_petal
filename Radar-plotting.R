...
write.table(first_line[1, 1], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE)
write.table(first_line[1, 2], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(first_line[1, 3], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(first_line[1, 4], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(first_line[1, 5], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)

write.table(circos[1, 1], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(circos[1, 2], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(circos[1, 3], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(circos[1, 4], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(data$bezier, "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
write.table(data$text, "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)

last_line <- data.frame(paste("</svg>"))
write.table(last_line[1, 1], "Radar-plotting.svg", col.names = FALSE, row.names = FALSE, quote = FALSE, append = TRUE)
